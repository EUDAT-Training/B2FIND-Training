...
is a little bit cumbersome because you can not (yet) really specify an interval of years heer. But at least you can use the wildcard `?` to specify the first two decadels of the given periode :
