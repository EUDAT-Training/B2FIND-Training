...
### 1. The Python script
All functionality to convert spreadsheet data into well-formatted xml files is provided by the script [mdmanager.py](mdmanager.py). Its usage is described in [00.mdmanager-script.md](00.mdmanager-script.md) and in this part of the tutorial we will use the operation mode *g*, i.e. with the otption `--mode g`.

For dependencies please refer to **Module 00**.
