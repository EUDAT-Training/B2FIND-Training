...
<img align="centre" src="img/B2FIND_ResultPage_FreeText_coast.png" width="800px">
...
<img align="right" src="img/B2FIND_Communities.png" width="80px">
...
<img align="centre" src="img/B2FIND_SearchCommunity_PDC.png" width="800px">
...
<img align="centre" src="img/CKAN_SearchCommunity_governo.png" width="800px">
 
##### Example 3.b : Search for a Creator ( or Author)
...
To filter out e.g. all datasets created by `Dustin Whalen` we use first the autocomplete functionality by entering `Wh` in the according field 'Filter' to shrink the list ov shown values to a managable number.
...
Again we first display all available disciplines 

<img align="centre" src="img/B2FIND_ShowDisciplines.png" width="800px">

and shrink the resulting value list to all including 'Env'.

<img align="centre" src="img/B2FIND_ShrinkDisciplines_Env.png" width="800px">


and then filter out e.g. all datasets belonging to the research field `Environmental Science` 

<img align="centre" src="img/B2FIND_SelectDiscipline_EnvironmentalScience.png" width="800px">
...
But note that the search request will not excecuted until the `loop` button in the very right upper corner of the website is hit.
...
<img align="left"  src="img/B2FIND_PublYear_ChooseDecade.png" width="50px">
<img align="centre" src="img/B2FIND_PublYear_ChooseYear.png" width="50px">
<img align="right" src="img/B2FIND_PublYear_Result.png" width="50px">
...
To search e.g. for all datasets which spatial extent has an overlap with a small region araound the boarder line at the northern border between Alaska and Canada, click on the 'Draw Rectangle' button in the top right of the world map widget of the 'Filter of Location' interface.

<img align="centre" src="img/B2FIND_FilterByLocation_DrawRectangleButton.png" width="800px">

Now you can select a region by dragging the cursor over the related box in the world map

<img align="centre" src="img/B2FIND_FilterByLocation_AlaskaCanadaCoast.png" width="800px">
and press finally the 'Apply' button.
