...
<figure>
	...
	<figcaption>Preselect a periode from the histogram.</figcaption>
</figure>
<img align="centre" src="img/B2FIND_FilterByTime_Preselect.png" width="270px">
<img align="centre" src="img/B2FIND_FilterByTime_SelectStartEndValues.png" width="270px">
...
** Excercise 8** : Find all datasets in B2FIND that are published before 1400. Analyse and interprete the result.
