...
<img align="right" src="img/B2FIND_FreeTextField.png" width="300px">
...
On the top you find a general query field for [free text search](#FreeTextSearch) and on the left-hand in the navigation bar side several preimplemented interfaces and pop up menues are provided to perform [facetted search](FacettedSearch).
