...
Please replace in the following the variable `CKAN-URL` with the URL of the used CKAN installation.
...
**Exercise 1** : List all tags (keywords) 

**Exercise 2** : List all datasets (packages)
...
<img align="centre" src="img/CKAN_SearchAuthor_Haseeb.png" width="260px">
...
<img align="centre" src="img/B2FIND_FilterByTime_SelectStartEndValues.png" width="260px">
...
<img align="right" src="img/B2FIND_FilterByTime_StartEndValues.png" width="260px">
...
<img align="left" src="img/B2FIND_FilterByLocation_DrawRectangleButton.png" width="260px">
<img align="left" src="img/B2FIND_FilterByLocation_AlaskaCanadaCoast.png" width="260px">
