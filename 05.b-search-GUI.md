...
In the following sections we illustrate the usage of the interface by inspecting several 'search use cases', i.e. specific searches in the B2FIND catalogue for the facets listed in the B2FIND schema (see *03.a-map-metadata.md* ).
